...
import com.example.digitalbank.adapter.UserAdapter;
import com.example.digitalbank.cobranca.CobrancaConfirmaActivity;
...
public class SelectUserActivity extends AppCompatActivity implements UserAdapter.OnClick {
    ...
    private void configRv(){
        ...
        usuarioAdapter = new UserAdapter(usuarioList, this);
