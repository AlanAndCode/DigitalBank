...
public class PagarCobrancaFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pagar_cobranca_form);
    ...
    private void salvarExtrato(Usuario usuario, String tipo){
        ...
        extrato.setOperation("PAGAMENTO");
    ...
    private void salvarPagamento(Extrato extrato) {
        ...
        payment.setId(extrato.getId());
        payment.setIdCobranca(cobranca.getId());
        payment.setValor(cobranca.getValor());
        payment.setIdUserDestino(usuarioDestino.getId());
        payment.setIdUserOrigem(usuarioOrigem.getId());

        DatabaseReference pagamentoRef = FirebaseHelper.getDatabaseReference()
                .child("payment")
                .child(extrato.getId());
        pagamentoRef.setValue(payment).addOnSuccessListener(aVoid -> {
        ...
        if(extrato.getType().equals("ENTRADA")){
            ...
            Intent intent = new Intent(this, ReceiptPayActivity.class);
            intent.putExtra("idPayment", payment.getId());
    ...
    private void getExtra(){
        notificacao = (Notify) getIntent().getSerializableExtra("notify");
    ...
    private void configDados(){
        ...
        textValor.setText(getString(R.string.text_value, GetMask.getValor(cobranca.getValor())));
